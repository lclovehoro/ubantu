...
RUN set -e \
    ...
    && apt-get install -y build-essential gcc wget libssl-dev zlib1g-dev libbz2-dev  libreadline-dev libgssapi-krb5-2 libssl1.0.0  libapt-pkg5.0 libicu* libcurl3-gnutls \
